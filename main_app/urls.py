...
urlpatterns = [
    ...
    path("profile_change_requests/", hod_views.profile_change_requests, name='profile_change_requests'),
    path("profile_change_requests/review/<int:request_id>", hod_views.review_profile_change, name='review_profile_change'), 
    ...
    path("staff/attendance/update/save/",
